...
import com.gedoor.mkiconapk.BuildConfig;
...
public class UpdateUtil {
    ...
    private static void promptUpdate(Context context, AppVersion version) {
        new AlertDialog.Builder(context)
                .setTitle(context.getString(com.gedoor.mkiconapk.R.string.update_available, version.getVersionName()))
                .setMessage(TextUtils.isEmpty(version.getChangeLog())
                        ? null
                        : version.getChangeLog())
                .setNegativeButton(com.gedoor.mkiconapk.R.string.update_cancel, null)
                .setPositiveButton(com.gedoor.mkiconapk.R.string.update_confirm, (dialog, which) -> {
                    try {
