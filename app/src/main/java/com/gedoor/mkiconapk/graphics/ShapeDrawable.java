...
public class ShapeDrawable extends CompositeDrawable {
    ...
    public ShapeDrawable(Resources resources, Shape shape, @ColorRes int color) {
        super(resources);
        indicator = resources.getDrawable(com.gedoor.mkiconapk.R.drawable.ic_check_white_24dp);
        size = resources.getDimensionPixelSize(com.gedoor.mkiconapk.R.dimen.launcher_size);
        setShape(shape);
